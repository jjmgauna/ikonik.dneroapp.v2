...
$url = 'https://dneroapp68061.api-us1.com';
...
$params = array(
    ...
    'api_key'      => '993539bf27a4f14427a8f94e94aba6b63fcfac7dd4ff5da8916fdc01f5f3a0f4d585c923',
...
$post = array(
    'email'                    =>  '1-'.$_POST["phoneNumber"].'@dneroapp.com',
    'first_name'               => 'FirstName',
    'last_name'                => 'LastName',
    'phone'                    => '+1'.' '.$_POST["phoneNumber"],
    'customer_acct_name'       => 'DneroApp web',
    'tags'                     => 'api',
    //'ip4'                    => '127.0.0.1',
...
print_r($post);
echo '</pre>';?>*/
echo "+1 "." ".$_POST["phoneNumber"]." Registered";
?>